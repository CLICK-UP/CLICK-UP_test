...
int Empty18::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty18::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty18::push(int i, Packet* p)
{
