...
int Empty13::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty13::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty13::push(int i, Packet* p)
{
