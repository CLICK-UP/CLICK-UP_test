...
int Empty24::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty24::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty24::push(int i, Packet* p)
{
