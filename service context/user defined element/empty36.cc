...
int Empty36::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty36::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty36::push(int i, Packet* p)
{
