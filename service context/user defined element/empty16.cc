...
int Empty16::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty16::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty16::push(int i, Packet* p)
{
