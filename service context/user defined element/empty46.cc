...
int Empty46::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty46::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty46::push(int i, Packet* p)
{
