...
int Empty49::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty49::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty49::push(int i, Packet* p)
{
