...
int Empty26::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty26::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty26::push(int i, Packet* p)
{
