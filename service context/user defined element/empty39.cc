...
int Empty39::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty39::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty39::push(int i, Packet* p)
{
