...
int Empty37::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty37::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty37::push(int i, Packet* p)
{
