...
int Empty12::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty12::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty12::push(int i, Packet* p)
{
