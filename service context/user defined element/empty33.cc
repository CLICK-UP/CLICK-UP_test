...
int Empty33::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty33::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty33::push(int i, Packet* p)
{
