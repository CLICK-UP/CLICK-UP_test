...
int Empty32::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty32::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty32::push(int i, Packet* p)
{
