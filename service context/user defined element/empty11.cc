...
int Empty11::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty11::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty11::push(int i, Packet* p)
{
