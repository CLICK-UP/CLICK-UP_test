...
int Empty20::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty20::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty20::push(int i, Packet* p)
{
