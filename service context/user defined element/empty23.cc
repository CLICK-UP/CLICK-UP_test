...
int Empty23::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty23::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty23::push(int i, Packet* p)
{
