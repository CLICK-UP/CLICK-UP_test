...
int Empty38::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty38::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty38::push(int i, Packet* p)
{
