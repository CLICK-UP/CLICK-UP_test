...
int Empty50::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty50::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty50::push(int i, Packet* p)
{
