...
int Empty47::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty47::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty47::push(int i, Packet* p)
{
