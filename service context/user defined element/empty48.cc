...
int Empty48::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty48::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty48::push(int i, Packet* p)
{
