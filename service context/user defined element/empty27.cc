...
int Empty27::initialize(ErrorHandler *errh)
{
	errh->message("Successfully initialized.");
	return 0;
}

int Empty27::configure(Vector<String>& conf, ErrorHandler* errh)
{
...
void Empty27::push(int i, Packet* p)
{
