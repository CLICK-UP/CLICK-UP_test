...
ifconfig p1 10.0.0.2/24
ifconfig p1 hw ether ee:43:35:3d:55:7c
ifconfig p1 up 
ifconfig p1 promisc
ifconfig p1 mtu 1400
ovs-vsctl add-port vfunc-br vfunc-forward -- set interface vfunc-forward type=gre options:df_default=true options:in_key=flow options:local_ip=192.168.1.42 options:out_key=flow options:remote_ip=192.168.1.13
