...
ovs-vsctl add-port clickup clickup-forward -- set interface clickup-forward type=gre options:in_key=flow options:local_ip=192.168.0.13 options:out_key=flow options:remote_ip=192.168.0.41
ovs-vsctl add-port clickup clickup-backward -- set interface clickup-backward type=gre options:in_key=flow options:local_ip=192.168.0.13 options:out_key=flow options:remote_ip=192.168.0.42
